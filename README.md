...
├── brute_force_data/                  # Brute-force checker and generated results
│   ├── brute_force.cpp                # Standalone exhaustive enumeration checker
...
│       ├── fig1_physical_env.png      # Physical coupling graph
│       ├── fig2_circuit.png           # Quantum circuit diagram
│       ├── fig3_monomorphism.png      # Subgraph monomorphism example
│       ├── fig4_pipeline.png          # Algorithm pipeline overview
│       ├── fig5_permutation.png       # Permutation routing example
│       ├── fig6_finetuning.png        # Hill-climbing fine-tuning
│       ├── flow1_pipeline.png         # Flowchart: full placement pipeline
│       ├── flow2_basic_placement.png  # Flowchart: basicPlacement
│       ├── flow3_fine_tuning.png      # Flowchart: fineTuning
│       ├── flow4_router.png           # Flowchart: SWAP router
...
g++ -std=c++17 -I include src/physical_env.cpp src/quantum_circuit.cpp `
    ...
    src/algorithm/circuit_placer.cpp `
    src/permutation/permutation_router.cpp `
    brute_force_data/brute_force.cpp -o brute_force.exe
.\brute_force.exe
